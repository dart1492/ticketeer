...
import 'package:ticketeer/features/user_tickets/presentation/views/user_tickets_screen.dart'
    as _i8;
import 'package:ticketeer/features/welcome/welcome_screen.dart' as _i9;
...
abstract class $AppRouter extends _i12.RootStackRouter {
  ...
  final Map<String, _i12.PageFactory> pagesMap = {
    ...
    MoviesRoute.name: (routeData) {
      return _i12.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i5.MoviesScreen(),
      );
    },
    MainBottomBarRoute.name: (routeData) {
      return _i12.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i6.MainBottomBarScreen(),
      );
    },
    ...
    UserTicketsRoute.name: (routeData) {
      return _i12.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.UserTicketsScreen(),
      );
    },
...
class MovieFiltersRouteArgs {
  ...
  final _i14.HomeMoviesCubit cubit;
...
class CommentsRoute extends _i12.PageRouteInfo<CommentsRouteArgs> {
  CommentsRoute({
    _i13.Key? key,
    required _i16.MovieCubit cubit,
...
class CommentsRouteArgs {
  ...
  final _i16.MovieCubit cubit;

  final int movieId;

  @override
  String toString() {
    return 'CommentsRouteArgs{key: $key, cubit: $cubit, movieId: $movieId}';
  }
}
